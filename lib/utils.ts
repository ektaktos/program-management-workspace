...
export function fmt12hr(time: string): string {
...
export function getSeedData(): AppState {
  return {
    ...
    tasks: [
      { id: 'mondhwtavpir', projectId: 'mond8mndfiqx', phaseId: 'monda3m58l72', title: 'Email Sarim to update Slide deck', description: '', priority: 'medium', status: 'done', due: '2026-05-01', dueTime: '22:30', assignee: 'Oyin', alerts: [{ value: 10, unit: 'minutes' }] },
      { id: 'monhzjdp8ild', projectId: 'mond8mndfiqx', phaseId: 'monda3m58l72', title: 'Send meeting Summary', description: '', priority: 'medium', status: 'done', due: '2026-05-01', dueTime: '20:00', assignee: 'Oyin', alerts: [{ value: 30, unit: 'minutes' }] },
      { id: 'moni8blze391', projectId: 'mond8mndfiqx', phaseId: 'monda3m58l72', title: 'Create two versions of posters', description: '', priority: 'high', status: 'inreview', due: '2026-05-04', dueTime: '12:00', assignee: 'Oyin', alerts: [{ value: 1, unit: 'days' }] },
